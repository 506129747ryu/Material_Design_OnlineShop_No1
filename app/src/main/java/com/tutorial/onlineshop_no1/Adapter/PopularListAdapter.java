package com.tutorial.onlineshop_no1.Adapter;
...
import com.tutorial.onlineshop_no1.Activity.DetailActivity;
import com.tutorial.onlineshop_no1.Domain.PopularDomain;
import com.tutorial.onlineshop_no1.R;

import java.util.ArrayList;

public class PopularListAdapter extends RecyclerView.Adapter<PopularListAdapter.Viewholader> {
    ...
    @NonNull
    @Override
    public PopularListAdapter.Viewholader onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.viewholder_pop_list,
                parent,
                false);

        context = parent.getContext();

        return new Viewholader(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull PopularListAdapter.Viewholader holder, int position) {
